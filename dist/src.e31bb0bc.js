...
var model = [{
  ...
  type: 'text',
  value: 'Я из лесу вышел, был сильный мороз'
}, {
  type: 'columns',
  value: ['Гляжу', 'поднимается медленно в гору', 'Лошадка, везущая хворосту воз']
}];
exports.model = model;
...
_model.model.forEach(function (block) {
  $site.insertAdjacentHTML('beforeend', (0, _templates.GetValue)(block));
});
